...
public class VentanaCliente2 extends javax.swing.JFrame  implements Runnable{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eres el cliente 2");
    ...
    private void BotonEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEnviarActionPerformed
        ...
        if(!TextoaEnviar.getText().equals("")){
            try {
                this.flujoDeSalida.writeUTF("Cliente 2: " + TextoaEnviar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaCliente2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCliente2().setVisible(true);
            }
        });
    }
    ...
    public void run() {
            ...
            while (true){
                Date date = new Date();
                try {
                    if (!this.flujoDeEntrada.readUTF().contains("Cliente 2:")){
